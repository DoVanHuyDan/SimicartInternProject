...
<body>
    ...
    {                   // just pass $id from controller when updating
        ...
        $actionOfForm =  $_SERVER['REQUEST_SCHEME'] . "://" .  $_SERVER['HTTP_HOST'] . '/HornyMVC/admin/form/save';
    ...
    else
    {
         ...
         $actionOfForm =  $_SERVER['REQUEST_SCHEME'] . "://" .  $_SERVER['HTTP_HOST'] . '/HornyMVC/admin/form/updateChange/' . $id ;
            ...
            <table class='table table-hover table-responsive '>
                ...
                <tr>
                    ...
                    ?>
                        ...
                        <a href='/HornyMVC/admin/list.html' class='btn btn-danger'>Back products page</a>
                    </td>
                </tr>
            </table>
        </form>
