...
<head>
    ...
    <!--link to delete.js-->
    <script src="<?php echo $helper->getURL(); ?>HornyMVC/controllers/js/delete.js"></script>
    <!--link to update.js-->
    <script src="<?php echo $helper->getURL(); ?>HornyMVC/controllers/js/update.js"></script>
    <!--link to detial.js-->
    <script src="<?php echo $helper->getURL(); ?>HornyMVC/controllers/js/detail.js"></script>
